        ...
        <div className="container">
          ...
          <div className="services-grid">
            <div className="service-card">
              ...
              <h3>{t('home.services.individualTherapy.title')}</h3>
              <p>{t('home.services.individualTherapy.description')}</p>
              <Link to="/services" className="btn btn-secondary">{t('home.services.individualTherapy.learnMore')}</Link>
            </div>
            <div className="service-card">
              <div className="service-icon">💑</div>
              <h3>{t('home.services.couplesTherapy.title')}</h3>
              <p>{t('home.services.couplesTherapy.description')}</p>
              <Link to="/services" className="btn btn-secondary">{t('home.services.couplesTherapy.learnMore')}</Link>
            </div>
            <div className="service-card">
              <div className="service-icon">👨‍👩‍👧‍👦</div>
              <h3>{t('home.services.familyTherapy.title')}</h3>
              <p>{t('home.services.familyTherapy.description')}</p>
              <Link to="/services" className="btn btn-secondary">{t('home.services.familyTherapy.learnMore')}</Link>
            </div>
          </div>
        </div>
      </section>
